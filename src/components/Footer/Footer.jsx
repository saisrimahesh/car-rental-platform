        ...
        <Row>
          ...
          <Col lg="3" md="4" sm="6">
            <div className="mb-4">
              ...
              <p className="office__info">Sathyabama University,Semmencherry,Chennai</p>
              <p className="office__info">Phone: 9573532453</p>

              <p className="office__info">Email: voletisaisrimahesh@gmail.com</p>
